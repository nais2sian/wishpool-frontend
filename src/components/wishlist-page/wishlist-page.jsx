    ...
    <section className={`${styles.content} ${extraClass}`}>
      ...
      {currentCardsId.length ? (
        <div className={styles.menu}>
          <p className="text text_type_button">{`Choose what you want to delete | ${currentCardsId.length} selected`}</p>
          <div className={styles.btn_box}>
            ...
            >
              <img src={cancelIcon} alt="Deselect button." />
              <p className="text text_type_button ml-4">Deselect</p>
            </button>
            <button
              className={styles.btn}
              type="button"
            ...
            >
              <img src={trashIcon} alt="Delete card button." />
