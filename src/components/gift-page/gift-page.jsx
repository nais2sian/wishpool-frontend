  ...
  return (
    <section className={`${styles.content} ${extraClass}`}>
      ...
      <div className={styles.data_box}>
        <img className={styles.img} src={wishData.image} alt="Gift photo" />
        <div className={styles.gift_data}>
          <h2 className="text text_type_h1 mb-16">{`${wishData.price} EUR`}</h2>

          <p className="text text_type_main" style={{ maxWidth: "75%" }}>
            {`Added ${new Date(
              wishData.createdAt
            ).toLocaleDateString()} by the user `}
            <NavLink
      ...
      <div className={styles.supported_box}>
        <div className={styles.subtitle_box}>
          <h2 className="text text_ty-e_h2">List of contributors</h2>
        </div>
      ...
      {isPopupOpen && (
        ...
        >
          <div className={styles.popup}>
            <h2 className="text text_type_h2 mb-20">Contribute any amount</h2>
